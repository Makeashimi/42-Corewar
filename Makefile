...
#    Updated: 2018/02/14 15:27:28 by jcharloi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ASM_SRC_NAME = main.c parsing_name.c parsing_comment.c parsing_instructions.c parsing_parameters.c instructions.c tools.c param.c
